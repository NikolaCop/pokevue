<template>
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div v-if="state.pokemon.sprites" class="card bg-light" style="width: 18rem;">
        <img class="card-img-top bg-light" :src="state.pokemon.sprites.front_default" alt="Card image cap bg-light">
